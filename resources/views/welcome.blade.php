...
<head>
    ...
    <title>Laravel Livewire Survey</title>
                    ...
                    <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                        ...
                        <a href="https://laracasts.com"
                            ...
                            <div class="pt-3 sm:pt-5">
                                <h2 class="text-xl font-semibold text-black dark:text-white">Laravel Livewire Survey
                                </h2>

                                <p class="mt-4 text-sm/relaxed">
                                    Laravel Livewire Survey helps you collect surveys from users, and conduct research.
                                    Register for an account to send your first survey.
                                </p>
                            </div>
